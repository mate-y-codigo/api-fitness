...
{
    public class ValidatorExerciseSearchByIdRequest : IValidatorExerciseSearchByIdRequest
    {
        private readonly IExcerciseQuery<Ejercicio> _excerciseQuery;

        public ValidatorExerciseSearchByIdRequest(IExcerciseQuery<Ejercicio> excerciseQuery)
        {
